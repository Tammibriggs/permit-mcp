...
class MCPClient:
    ...
    async def process_query(self, query: str) -> str:
        ...
        response = self.anthropic.messages.create(
            ...
            max_tokens=1000,
            system=f"""
            List **ALL** available operations once the user provides their name, including management-related opertions. **Do not** omit any operations, even those that seem restricted as tools are assigned based on privilege.
